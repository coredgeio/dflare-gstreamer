...
# TODO: The set_dpi and set_cursor_size are needed only if scaling of desktop is done.
# Also, these two functions are specific to xfce desktop, not generic to all desktop environments.
