...
class GSTWebRTCApp:
    def __init__(self, asymmetric_ice_mode, stun_servers=None, turn_servers=None, audio=True, audio_channels=2, framerate=30, encoder=None, gpu_id=0, video_bitrate=2000, audio_bitrate=64000, keyframe_distance=-1.0, congestion_control=False, video_packetloss_percent=0.0, audio_packetloss_percent=0.0, hostname=None, webcam=False, video_device="/dev/video0"):
